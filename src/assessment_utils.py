...
def sample_vectors_to_points(
    ...
    Inputs:
        ...
        canopy_vector_file: Directory containing canopy polygons.
        green_vector_file: Directory containing green cover polygons.
    ...
    try:
        ...
        if os.path.exists(green_vector_file):
            green_gdf = gpd.read_file(green_vector_file)
        ...
        if os.path.exists(canopy_vector_file):
            canopy_gdf = gpd.read_file(canopy_vector_file)
